...
#define SSP_MEMORY_REMAP_SZIE 0x05880000
#define TSP_MEMORY_REMAP_SZIE 0x02000000

int ssp_init(uint64_t load_addr)
{
...
int tsp_init(uint64_t load_addr)
{
    struct ast2700_scu0 *scu;
    uint32_t reg_val;
    ...
    writel(TSP_MEMORY_REMAP_SZIE, (void *)&scu->tsp_remap_size);
